...
function $RouteProvider(){
  ...
  this.$get = ['$rootScope', '$location', '$routeParams',
     ...
     *
     * The `$route` services is typically used in conjunction with {@link angular.module.ng.$compileProvider.directive.ngView ngView}
 ...
 * @description
 * # Overview
 * `ngView` is a directive that complements the {@link angular.module.ng.$route $route} services by
