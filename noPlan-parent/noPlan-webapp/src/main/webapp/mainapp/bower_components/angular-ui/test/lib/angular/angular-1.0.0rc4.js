    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * @description
           * See {@link angular.module.AUTO.$provide#service $provide.services()}.
           */
...
/**
 * @ngdoc method
 * @name angular.module.AUTO.$provide#services
 * @methodOf angular.module.AUTO.$provide
 * @description
 *
...
function Browser(window, document, body, $log, $sniffer) {
   ...
   * {@link angular.module.ng.$location $location services} to change url.
   *
   ...
   *
   * NOTE: this api is intended for use only by the $location services. Please use the
   * {@link angular.module.ng.$location $location services} to monitor url changes in angular apps.
   *
 ...
 * @description
 * The {@link angular.module.ng.$controller $controller services} is used by Angular to create new
 * controllers.
 *
 ...
 * {@link angular.module.ng.$exceptionHandler $exceptionHandler} services.
 *
...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', function($parse) {
     ...
     * HTML {@link angular.module.ng.$compile $compile} services for data binding. See
 ...
 *
 * @description
 * The $location services parses the URL in the browser address bar (based on the {@link https://developer.mozilla.org/en/window.location window.location}) and makes the URL available to your application. Changes to the URL in the address bar are reflected into $location services and changes to $location are reflected into the browser address bar.
 *
 ...
 *
 * @description
 * Simple services for logging. Default implementation writes the message
...
function $RouteProvider(){
  ...
  this.$get = ['$rootScope', '$location', '$routeParams',
     ...
     *
     * The `$route` services is typically used in conjunction with {@link angular.module.ng.$compileProvider.directive.ng-view ng-view}
     * directive and the {@link angular.module.ng.$routeParams $routeParams} services.
     *
     * @example
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
       ...
       * onto the {@link angular.module.ng.$exceptionHandler $exceptionHandler} services.
       *
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     * the $q services. While for simple usage patters this doesn't matter much, for advanced usage,
     * it is important to familiarize yourself with these apis and guarantees they provide.
     *
     *
     * # General usage
     * The `$http` services is a function which takes a single argument â€” a configuration object â€”
     ...
     * # Shortcut methods
     *
     * Since all invocation of the $http services require definition of the http method and url and
 ...
 *
 * @description
 * HTTP backend used by the {@link angular.module.ng.$http services} that delegates to
 ...
 * {@link angular.module.ng.$sanitize $sanitize} services and innerHTML the result into the current
 * element.
 *
 * See {@link angular.module.ng.$sanitize $sanitize} docs for examples.
 *
 ...
 * @description
 * # Overview
 * `ng-view` is a directive that complements the {@link angular.module.ng.$route $route} services by
